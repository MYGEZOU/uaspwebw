        ...
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="index.php">
                <h3 class="brand-text">DARTAR TURNAMEN</h3></a></li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="active"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="">Dashboard Hospital</span></a>
          </li>
          <li class=" navigation-header"><span data-i18n="nav.category.professional">Professional</span><i class="la la-ellipsis-h ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="Professional"></i>
          </li>
          <li class=" nav-item"><a href="#"><i class="la la-edit"></i><span class="menu-title" data-i18n="">Appointment</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="hospital-doctor-schedule.html">Doctor Schedule</a>
              </li>
              <li><a class="menu-item" href="hospital-book-appointment.html">Book Appointment</a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="la la-stethoscope"></i><span class="menu-title" data-i18n="">Doctors</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="hospital-doctors-list.html">All Doctors</a>
              </li>
              <li><a class="menu-item" href="hospital-add-doctor.html">Add Doctors</a>
              </li>
              <li><a class="menu-item" href="hospital-doctor-profile.html">Doctor Profile</a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="la la-users"></i><span class="menu-title" data-i18n="">Patients</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="hospital-patients-list.html">All Patients</a>
              </li>
              <li><a class="menu-item" href="hospital-add-patient.html">Add Patients</a>
              </li>
              <li><a class="menu-item" href="hospital-patient-profile.html">Patient Profile</a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="hospital-payment-reports.html"><i class="la la-bar-chart"></i><span class="menu-title" data-i18n="">Report</span></a>
          </li>
          <li class=" nav-item"><a href="#"><i class="la la-dollar"></i><span class="menu-title" data-i18n="">Payments</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="hospital-payments.html">Payments</a>
              </li>
              <li><a class="menu-item" href="hospital-add-payments.html">Add Payments</a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="full-calender-basic.html"><i class="la la-calendar"></i><span class="menu-title" data-i18n="">Calendar</span></a>
          </li>
          <li class=" nav-item"><a href="email-application.html"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">Inbox</span></a>
          </li>
          ...
          <tbody>
            <tr>
              ...
              <td class="text-right border-top-0">
                <a href="book-appointment.html" class="btn btn-sm btn-outline-success">Book Appointment</a>
              </td>
            </tr>
            <tr>
